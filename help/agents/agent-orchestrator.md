...
| --- | --- | --- |
| [Adobe Marketing Agent für [!DNL Microsoft 365 Copilot]](ama-ms.md) | Sofortiges Abrufen von Marketing-Einblicken aus Adobe Experience Platform in [!DNL Microsoft 365] Apps wie [!DNL Teams], [!DNL Word], [!DNL Powerpoint] und [!DNL Excel]. Mit diesem Agenten können Sie den Chat-Verlauf über Apps hinweg verwalten und Ihre Konversation während der Arbeit nahtlos fortsetzen. |
